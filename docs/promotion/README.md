...
3. Post the launch:
   ...
   - Reddit / LocalLLaMA: `reddit-local-llama.md`
   - Reddit / open source or programming communities: `reddit-open-source.md`
   - X, Bluesky, LinkedIn: `social-short-posts.md`
   - Product Hunt, if you can work the comments for a day: `product-hunt.md`
4. Use `reply-bank.md` for comments and hard questions.
5. Reuse `long-form-article.md` for a blog, Dev.to, Hashnode, or a GitHub
   Discussion.
6. Use `outreach-notes.md` for low-volume creator/newsletter outreach.
...
> If this is useful, a star helps other people find it. Provider free tiers drift,
> so model-id and limit reports are especially valuable.
