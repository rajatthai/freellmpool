...
the "estimated cost avoided" reflects what these tokens would have cost on that reference model.
The label never says "earnings" — it's a fun, honest metric that states the
baseline so the number is interpretable, not inflated by sleight of hand.
"""
